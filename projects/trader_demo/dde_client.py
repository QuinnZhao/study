...
if __name__ == "__main__":
    ...
    while True:
        # print(dde.request('spHSIJ8').decode('gbk'))  # original return data is byte array encoded by 'gbk'
        print(dde.request('spHSIH8').decode('gbk'))  # original return data is byte array encoded by 'gbk'
        # print(dde.request('spHHIH8').decode('gbk'))  # original return data is byte array encoded by 'gbk'

        time.sleep(5)

    # dde1 = DdeClient('Excel', '[test11.xlsx]sheet2')
    # data = str(100).encode(encoding='utf-8')
    # data1 ='2003.001'.encode(encoding='utf-8')
    # dde1.poke('R1C1', data)
